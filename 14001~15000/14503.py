...
# 로봇 청소기가 있는 장소는 N X M 크기의 직사각형으로 나타낼 수 있으며, 1 X 1 크기의 정사각형 칸으로 나누어져 있다.
...
def cleaning(rx, cy, d):
    ...
    while deq:
        ...
        for i in range(4):
            ...
            # 왼쪽 방향에 청소하지 않은 공간이 있는 경우, 청소하고 전진 후 다시 1번으로
