...
# 입력: 첫째 줄에 상근이가 가지고 있는 숫자 카드의 개수 N이 주어진다. 둘째 줄에는 숫자 카드에 적혀있는 정수가 주어진다.
# 셋째 줄에는 M이 주어진다. 넷째 줄에는 상근이가 몇 개 가지고 있는 숫자 카드인지 구해야 할 M개의 정수가 주어지며, 이 수는 공백으로 구분되어져 있다.
